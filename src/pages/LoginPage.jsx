          ...
          <div className="loginPage__form">
            ...
            <div className="loginPage__iconos">
              <div className="loginPage__borderIconFacebook">
                <a href="https://proyect-back-end-coder-production.up.railway.app/api/facebook" className="loginPage__facebook">
                  <BsFacebook size={20} /> Ingresar con Facebook
                </a>
              </div>
              <div className="loginPage__borderIconGoogle">
                <a href="https://proyect-back-end-coder-production.up.railway.app/api/google" className="loginPage__google">
